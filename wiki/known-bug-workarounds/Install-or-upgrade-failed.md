...
Workaround:
- Open the Noxfold-Sync menu -> Import & Export -> Export config
- Open the Noxfold-Sync menu -> Exit
- Android settings -> Apps -> Noxfold-Sync -> Force stop
- Android settings -> Apps -> Noxfold-Sync -> Uninstall, do NOT keep data when Android asks (this refers to the app's config, not your synced folders)
- Install latest release
- Open the Noxfold-Sync menu -> Import & Export -> Import config
