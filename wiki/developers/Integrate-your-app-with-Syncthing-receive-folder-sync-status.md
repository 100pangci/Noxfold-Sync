...
You can receive the folder sync complete event from Noxfold-Sync by using a BroadcastReceiver to subscribe.
...
- Start test app and follow the logcat while Noxfold-Sync is running and about to complete a folder sync progress.
```
