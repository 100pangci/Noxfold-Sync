...
IF NOT DEFINED PID echo [ERROR] Noxfold-Sync DEBUG is NOT installed. & FOR /F "delims=" %%I IN ('adb shell pidof %PACKAGE_NAME:.debug=%') DO SET PID=%%I
IF NOT DEFINED PID echo [ERROR] Noxfold-Sync RELEASE is NOT installed. Please install it first. Stop. & goto :eof
::
